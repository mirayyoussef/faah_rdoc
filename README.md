%% ================================================================
%% MATLAB Analysis Script (No Figures)
%% ================================================================
...
%% 9. Impulsivity Decision Measures
...
%% 10. Summary of PET Correlations
min_p_pet = min(p_pet(:));
max_r_pet = max(r_pet(:));
min_r_pet = min(r_pet(:));
...
%% 13. Whole-Brain PET Screening (all pet ROIs with covariates)
for i=1:42
...
%% 14. Whole-Brain PET Screening (all pet ROIs+ group+covariates)
for i=1:42
